<template>
    <div class="planet-card">
        ...
        <div class="temperature">
            <p v-if="planetInfo.meanTemp" title="Surface temperature">Rata-rata: 
        ...
        <div class="info">
            ...
            <ul>
                <li>Jari-jari: <span class="value">{{ planetInfo.radius }} km</span></li>
                <li v-if="planetInfo.timesLarger && planetInfo.timesLarger !== -1">
                    <span v-if="planetInfo.timesLarger >= 1"><span class="value">{{ planetInfo.timesLarger }}x</span> lebih besar dari Bumi</span>
                    <span v-else><span class="value">{{ (1 / planetInfo.timesLarger).toFixed(2) }}x</span> lebih kecil dari Bumi</span>
                </li>
                <li v-if="planetInfo.distanceFromSun && planetInfo.distanceFromSun !== -1">Jarak dari Matahari: <span class="value">{{ planetInfo.distanceFromSun }} SA</span></li>
                <li v-if="planetInfo.distance">Jarak dari {{ planetInfo.orbitObject.charAt(0).toUpperCase() + planetInfo.orbitObject.slice(1) }}: <span class="value">{{ planetInfo.distance }} km</span></li>
                <li v-if="planetInfo.year">1 tahun: <span class="value">{{ planetInfo.year }}</span></li>
                <li v-if="planetInfo.day">1 hari: <span class="value">{{ planetInfo.day }}</span></li>
                <li v-if="planetInfo.moons != null">Satelit: <span class="value">{{ planetInfo.moons }}</span></li>
            </ul>
        </div>
    </div>
</template>
