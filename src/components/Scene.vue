    ...
    methods: {
        ...
        createSolarSystem: async function(scene) {
            ...
            for (let planet of PLANETS) {
                ...
                // Get the object the planet is orbiting
                if (planet.orbitObject != null) {
                    ...
                    // Load and apply texture to the planet
                    const texture = textureLoader.load(`./assets/textures/${planet.name}.jpg`);
                    ...
                    // Load and apply texture based on the planet type
                    ...
                    switch (planet.name.toLowerCase()) {
                        ...
                        case 'neptune':
                            ...
                            break;
                        case 'callisto':
                            texturePath = './assets/textures/callisto.jpg';
                            break;
                        case 'europa':
                            texturePath = './assets/textures/europa.jpg';
                            break;
                        case 'ganymede':
                            texturePath = './assets/textures/ganymede.jpg';
                            break;
                        case 'io':
                            texturePath = './assets/textures/io.jpg';
                            break;
                        case 'moon':
                            texturePath = './assets/textures/moon.jpg';
                            break;
                        case 'titan':
                            texturePath = './assets/textures/titan.jpg';
                            break;
                        case 'triton':
                            texturePath = './assets/textures/titan.jpg';
                            break;
                        default:
                            texturePath = './assets/textures/default.jpg';
                    }
        ...
        loadBackgroundMusic() {
            const musicPath = '.assets/solar-system.mp3';
